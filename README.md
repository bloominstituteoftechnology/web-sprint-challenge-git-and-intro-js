...
Web accessibility is the inclusive practice of ensuring there are no barriers that would prevent anyone from using or interacting with your website or application.

2. Talk about 3 different things you can do to ensure your website is accessible.
Adding media queries to adjust the size of your page for different screen sizes, add alt text to images, and avoid small fonts to make things easier to read.

3. How would you explain the concept of a variable to someone new to programming?
JavaScript variables are containers for storing data.

4. What is the purpose of using functions in code?
The purpose of Javascript function is to preform a task or calculate a value.
