...
think about all the ways people interact with webpages. accessibility is making your webpage able to interact with those means. 
2. Talk about 3 different things you can do to ensure your website is accessible. 
responsive design, fast load times, minimal data usage. 
3. How would you explain the concept of a variable to someone new to programming?
a variable is a container you can use to store data and call upon later. 
4. What is the purpose of using functions in code?
to quickly repeat tasks without having to repeat yourself in your code. 
