...
1. How would you describe preprocessing to someone new to CSS?
   it's a easier way to code CSS that generates pure CSS from the preprocesser. There are a few different laguager like less,stylus, and sass. All have there own unique syntax that give you more control over CSS.
2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?
   favorite: Nesting.
   most problems:mixins.
3. How would you explain the concept of a variable to someone new to programming?
   Variable is one way to store change and use data in code.
4. What is the purpose of using functions in code?
   They allow you to recall sections of code or programs by using a single line. Makes your code DRY
5. What is JSON data?
