...
Web accesibility is a way to size and resize our webpages to fit different screen sizes. (consider desktop, mobile, and tablet widths)

2. Talk about 3 different things you can do to ensure your website is accessible. 
You can use flexible, responsive units for size, add breakpoints at key size points, and you also should not be forgetting the meta viewport tag.
