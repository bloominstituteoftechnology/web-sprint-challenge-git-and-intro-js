...
-Acessibility on the web is making sure your site is easily functional to all types of people, also so people with disabilities can use them.


2. Talk about 3 different things you can do to ensure your website is accessible. 
- alt tags put on to img tags are used for screen reading programs to tell people with certain disabilitis what the picture may look like.
-lang is also use to make a language known to the browser thst the page is in a certain language.
-also writing clear codes with h1-h6 using clear language  for other programers to use.

3. How would you explain the concept of a variable to someone new to programming?
- variabls are a way to store values so  you can use them later on in a forumula.

4. What is the purpose of using functions in code?
-Functions protect a block of code until they are ready to be used.
