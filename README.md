...
1. How would you describe acessibility on the web to someone new to programming?
   make sure you adhear to www standards.
2. Talk about 3 different things you can do to ensure your website is accessible.
   Make sure it is being hosted, make responsive and readable, use correct headings, alt text images, add hear to hearing requirement guidelines
3. How would you explain the concept of a variable to someone new to programming?
   a variable is a way to store information which you can later change or bring up when you need it to complete a task.
4. What is the purpose of using functions in code?
   we use functions to preform various task that need to be completed multiple times. instead of writing code multilple times we can call a function to complete the task
