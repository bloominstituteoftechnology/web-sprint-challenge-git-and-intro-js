...
1. How would you describe acessibility on the web to someone new to programming?
   Accessibility is the idea that your project, or creation, will be accessible to anyone, despite what device they are using, IE, screen readers, tablets, PC, mobile phones, tvs.
2. Talk about 3 different things you can do to ensure your website is accessible.
   Media Breakpoints, alt tags on photos, ensuring it is keyboard friendly.
3. How would you explain the concept of a variable to someone new to programming?
   A variable is designed to give you a platform to reduce volume. Allowing you to assign as many keystrokes as you want, to a simple, single character "variable".
4. What is the purpose of using functions in code?
   This is a pretty broad question, but to simplify it, using a function in a code, allows you to automate a task, and be able to use a simple callback to activate the automated task.
