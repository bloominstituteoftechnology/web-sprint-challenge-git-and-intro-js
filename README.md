...
Its the ability to make changes for people who have problems with certen things like color blind modes in games.Or alt tags for blind people.
2. Talk about 3 different things you can do to ensure your website is accessible. 
Never forget an alt tag, Make sure colored text is changeable, and make sure your website can be sized down for phone and tablets
3. How would you explain the concept of a variable to someone new to programming?
A variable is some that is going to apply change so I would describe it like math.
4. What is the purpose of using functions in code?
Functions hold code so that it isnt on the world scope.
