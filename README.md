...
acessibility is making ur page able to be accessed to anyone no matter what dissability or not 

2. Talk about 3 different things you can do to ensure your website is accessible. 
you can put alt tags on your images to describe what they are, make ur page change to fit better on mobile, dont use tables.


3. How would you explain the concept of a variable to someone new to programming?
the concept of a variable is it is basicaly a place holder for data u can use any word to hold some form of data

4. What is the purpose of using functions in code?
it is used to combine multiple tasks into smaller simplar code.
