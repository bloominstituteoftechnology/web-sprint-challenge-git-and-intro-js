...
1. How would you describe acessibility on the web to someone new to programming?
   Quite simply, it means no matter the size, format, or means that someone gets onto a page, that the page is still made in a way that they can fully and easily use the page.
2. Talk about 3 different things you can do to ensure your website is accessible.
   1.) make sure small widths don't look bad in any way. 2.) make sure really wide widths don't look bad in any way. 3.) make sure that mobile devices can still do everything despite not being able to hover over text.
3. How would you explain the concept of a variable to someone new to programming?
   A variable is really just a shorthand to some sort of information used for convenience and to make it easier to change small, consistent details.
4. What is the purpose of using functions in code?
   So you do not have to repeat code, and to make code easier to read.
