...
1. How would you describe acessibility on the web to someone new to programming?
   accessibility friendly websites include meta tags, alt texts, and other information that makes it easy for developers and people with acessibility restrictions to navigate your site.

2. Talk about 3 different things you can do to ensure your website is accessible.
   three easy things you can do to make your website more accessable are adding meta tags, adding alt-texts to images, and use headers and footers to structure your content

3. How would you explain the concept of a variable to someone new to programming?
   a variable is a storage container for information. Just like a pickle jar is a storage container for pickles

4. What is the purpose of using functions in code?
   functions allow you to manipulate data and preform tasks in javascript
