...
It is important that you consider some best practice advice to make sure that your use of CSS and JavaScript best practices that considered to ensure even complex content is as accessible as possible.
...
you can assign any type of literal values to a variable egg. string, integer, float, etc.
