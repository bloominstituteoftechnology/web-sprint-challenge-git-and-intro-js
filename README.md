...
1. How would you describe acessibility on the web to someone new to programming?
   Web accessibilty has to do with making web pages accessible to all. Whether you are visually impaired or slow internet connection.
2. Talk about 3 different things you can do to ensure your website is accessible.
   Screen readers: transmits web data or can translate content into braille
   Color: make colors contrasting, try to avoid reds and greens
   responsive units: changing the font size
3. How would you explain the concept of a variable to someone new to programming?
   a variable is used to store bits of information and the data stored can vary or change each time a script runs.
4. What is the purpose of using functions in code?
   a functionallows you to group statements together to perform a specific task.
