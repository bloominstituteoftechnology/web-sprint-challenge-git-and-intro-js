...
/* Task 2: There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method to fix this issue and console.log() to check your work. */ /*He is acutally the 8th*/
...
newartists = [artists];
  ...
  /*console.log(addArtist(id, Gina Pellon, 1926-2014, Abstract, Cuban, Gina Pellón (December 26, 1926 – March 27, 2014) was a Cuban painter who lived in France.[1] She was known for her abstract expressive paintings in strong colours, usually depicting women.[2] She also wrote collections of poems.));
