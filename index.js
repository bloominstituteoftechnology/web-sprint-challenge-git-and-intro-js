...
artists.fixName = function (list,index,newName){
  list[index].name = newName;
}

artists.fixName(artists,[8],"Vincent Van Gogh");
...
function getArtistByIndex(array, index) {
    ...
    return console.log(`The artist at index ${index} is ${name}`);
  }
...
function addArtist(array,id,name,years,genre,nationality,bio){
  newObj = {"id": id, "name":name, "years":years, "genre": genre, "nationality": nationality, "bio": bio};
  array.push(newObj);
  console.log(array);

  }

  addArtist(artists, 20, "Jake Colwell", "1993-2090", "Web Design", "Irish", "Originally from the harsh deserts of Pinal County, Az, Jake Colwell now presides in Northern KY; web-designing his days away")
