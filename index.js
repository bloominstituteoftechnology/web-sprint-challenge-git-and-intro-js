...
Acessibility is making websites easier to use for people who may have a disibility or limited equipment. 

2. Talk about 3 different things you can do to ensure your website is accessible.

1) Always put alt attributes in images. 2) Choose colors carefully to make sure they can be seen by the colorblind. 3)Use semantic elements. For example consider using "nav" instead of "div"

3. How would you explain the concept of a variable to someone new to programming?

It's a lot like the variables in Algebra if your familiar with that concept. It's giving a nickname to a value so that you can call it by it's nickname when you need to use it.

4. What is the purpose of using functions in code?

A function is a small digestable chunck of code that preforms a specific task. It makes code way easier to read. 
