...
//     return `The artist at index ${position.id} is ${position.name}`
//   }
...
//     if((arr1[i].years === "1907 - 1954") || (arr1[i].years === ("1904 - 1989"))) {
//         arr20th.unshift(arr1[i].name)  
//     }
//     console.log(arr20th)
...
*/
//Completed
// function removeArtist(arr1, index1) {
//     whoGone = arr1.splice(index1,1)
//     return console.log(`There are exactly ${arr1.length} elements remaining`)
//   }
