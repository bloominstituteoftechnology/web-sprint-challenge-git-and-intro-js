...
function getArtistByIndex(artists, id) { //define parameters
...
function listOfNames(artists) {
  let artistsNames = [] //new array
  for (let i = 0; i < artists.length; i++){ //loop
    let name = artists[i].name //define parameters
    artistsNames.push(name); //Salt-N-Pepa
  }   
  return artistsNames;
}
