...
console.log(addArtist(artists, 20, "Leah Tabush", "1991 - 2020", "Web Design", "'murica", "Boromir's destroy perils Bilbo Baggins regain seems! Wider Treebeard quietly faced hesitate fire-breathing value? Fisherman thinks Gollum's stove call shake taken?"));
...
// function getHTML(arr, tag, class, id, content){
//   let output = "";
//   for (let i in arr) {
//     if ('class' in i) && ('id' in i)) {
//       console.log(`<${tag} id="${id}" class="${class}">${content}</${tag}`)
//     }
//   }
// }
// getHTML(data);
