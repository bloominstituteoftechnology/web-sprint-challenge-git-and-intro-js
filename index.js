...
function getArtistByIndex(array, number) {
  return "the artist at index" + number + "is" + array[number];
}
...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    // refactoring "string digits" into numbers
    var splityears = array[i].years.split("-");
    splityears[0] = parseInt(splityears[0].trim());
    splityears[1] = parseInt(splityears[1].trim());
...
//activate function apply value to placeholderds
