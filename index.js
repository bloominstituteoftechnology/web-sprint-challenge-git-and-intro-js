...
function changeName(array, index region){
...
console.log(artists(name, years));
...
function addArtist(arr){
  ...
  addArtist(artist, id:21, name:Bradford Day, years: 1980-2020; nationality: White, bio: lorem ipsum);
