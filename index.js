...
function get20s(artists, years){
  if (years >= 1990 || years <= 2000){
    retun artists;
  }
}
console.log(get20s(artist, years));
...
*/
function removeArtist(array, artists) {
   artists.splice(2, 4);
}
...
function addArtist(artists, id, name, years, genre, nationality, bio){
  ...
  console.log(addArtist(artists, 20, "Casey Blatz", "1990-2050", "Web Design", "American", "Born in Arizona in Dec 1990. Made a living out of Web Design in Austin, Texas."));
