...
*/
function removeArtist(artists, 5) {
...
function addArtist(array, name, year, genre, nationality, bio){
  artists.push({name: "Samantha Dutcher", years: 1986-2020. genre: "Web Design", nationality: "Italian", bio: "Single mom on the come-up in life!"})
  return artists;
  }
