...
(1AbortSignalartist (0th index) in the array
*/
...
for (let i = 0; i < array.length; i++) {
  ...
  let age = array[i].years;

  let birthYear = age.substr(0, 4);

  let deathYear = age.substr(7, 4);
  birthYear = parseInt(birthYear);

  deathYear = parseInt(deathYear);

  if (deathYear <= 2000 && birthYear > 1900) {
      artistsArr.push(array[i].name);
...
*/
function removeArtist(objectArr, index) {
