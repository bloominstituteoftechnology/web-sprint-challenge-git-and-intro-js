...
function getArtistByIndex(array, index) {
  let actualName = artists[0];
  return `${artists.name} The artist at ${artists[0].name} is ${artists[0].name}.`;
}
 ...
 */
function removeArtist(array, byeArtist) {
  byeArtist.pop();
}
...
function lotsOfArt(hunnidPaints) {
  /* Code here */
}
