...
me = {
  ...
  bio:
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla leo nisi, imperdiet nec commodo at, feugiat vitae neque. Nam elit lectus, vestibulum molestie nisi id, rhoncus tempus nunc. Duis egestas ornare nibh, sit amet cursus erat luctus ut.'
}
...
function lotsOfArt (array) {
  ...
  for (let i = 0; i < array.length; i++) {
    if (array[i].paintings > 100) {
      tooMuchPainting.push(array[i].name)
    }
  }
  return tooMuchPainting
}
