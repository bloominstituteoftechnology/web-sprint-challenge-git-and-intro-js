...
artists.splice(8, 1, artists.name = "Vincent van Gough")
...
function get20s(array){
  ...
  for (i = 0; i < array.length; i++){
      if (array[i].years === "1907 - 1954"){
          newArr.push(array[i].name);
      } else if (array[i].years === "1904 - 1989"){
          newArr.push(array[i].name)
      } else {
          console.log('skip');
      }
...
const DB = {"id": 20,
    ...
    "bio": "I exist on planet Earth. Time is a relative variable."}
