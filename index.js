...
/* Task 2: There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh 
 ...
 *     getArtistByIndex returns a string in the format `The artist at index 
 *     {id} is {name}.`
 * 
 * For example, if getArtistByIndex is invoked with the artists dataset and the 
 * number 0,
...
(1900-2000) example born in 1901 and died in 1959 - included / born in 1889 and 
 ...
 * 
 * Note that sucessfully invoking this function multiple times without refreshing 
 * your browser will continuously remove artists from the array until there are 
 * none left. If you refresh your browser, the data will reset.  
*/
...
/**
/* Task 6: Create a function called `addArtist` that can accept an object of 
...
function addArtist(addArray){

  artists.push(addArray);
  console.log(artists);

  }

  let Sean = [{name: `sean`, futureJob: `Web Developer`}]
...
‼️ You do **NOT** need to get these to display on your page, but you can copy and 
paste the result into your HTML file if you'd like to see what that would look 
like. */
...
/* STRETCH 2: Create a function called `randomize` that takes a data array as 
an argument and returns a the same array in a randomized order. */
