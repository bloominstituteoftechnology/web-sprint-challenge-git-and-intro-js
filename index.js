...
function getArtistByIndex(arr, i) {
  let index = arr[i];
  let str = "the artist at index " + index.id + " is " + index.name;
  return str;
}  
...
function get20s(arr){
  ...
  for (let i=0; i < length; i++) {
    let century = arr[i].years;
    let born = century.slice(0,2);
    let died = century.slice(7,9);
...
let newObject = { 
  ...
  "genre": "Web Design", 
  "nationality": "Your Nationality Here",
  "bio": "This opera's as lousy as it is brilliant! Your lyrics lack subtlety. You can't just have your characters announce how they feel. That makes me feel angry!"
};
