...
//changing Vincent Van Dough to Vincent Van Gogh, array, index # and then .name to access names
...
// recieve array
// create new array set to empty []
function get20s(array) {
  let array1 = []
  // use for to run loop through array
  for(let i = 0; i < array.length; i++){
    // thanks google(took freakin hours)
    if(parseInt(array[i].years.split(' - ')[0]) >= 1900 && parseInt(array[i].years.split(' - ')[1]) <= 2000){
