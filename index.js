...
function addArtist(arr, id, name, years, genre, nationality){
    arr.push({id, name, years, genre, nationality});
    return arr;
  }

  console.log(addArtist(artists, 20,'Gabby', '1994-present','Modern', 'American'));
