...
function getArtistByIndex(array, num) {
  return `the astist at the index ${array[num].id} is ${array[num].name}`;
}  
...
function addArtist(array){
  ...
  const newArtist = {
    id: 24,
        ...
        genre: "Web Developer", 
        nationality: "Mexican",
        bio: "Was born in the United States but my parents are from mexico. Coding is my new hobby"
  }  
  
  return array.push(newArtists);
