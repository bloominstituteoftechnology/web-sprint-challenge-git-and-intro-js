...
console.log("The name of the 1st artists is:  ", artists[0].name);
console.log("The biography of the 3rd artist is:  ", artists[2].bio);

/* Task 2: There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method to fix this issue and console.log() to check your work. */

console.log("The 9th artist's name is a typo:  ", artists[8].name);
artists[8].name("Vincent Van Gogh");
console.log("The 9th artist's name is now correct:  ", artists[8].name);
...
function getArtistByIndex(array, index) {
    cconsole.log(`The artist at ${index[index].id} is ${array[index].name}`)   
  }
...
function get20s(artistData) {
  ...
  for (let i=0; i<artistData.length; i++) {
    const yearBorn=(artistData[i].years.substr(0,4));
    const yearDied=(artistData[i].years.substr(7,10));
    if (yearBorn >= 1900 && yearDied <= 2000) {
      artist20th.push(data[i].name);
    }
  }
return artist20th;
}
console.log("20th century artists:  ", get20s(artists));
...
function removeArtist(array, index) {
    ...
    console.log("The new array length is:  ", array.length);
  }
...
function addArtist(array, id, name, years, genre, nationality, bio){
  ...
  addArtist(artists, id="20", name="Chris Elles", years="1969-2020", genre="Problem Solver", nationality="USA/NZ", bio="Trying the make the world a better place." );
...
function lotsOfArt(artistData){
  let artistNames=[];
  for (let i=0; i < artistData.length; i++) {
    if artistData[i].paintings > 100) {
      artistNames.push(data[i].name);
    }
  }
   return artistNames;
}
console.log("Artists with over 100 paintings:  ", lotsOfArt(artists));
