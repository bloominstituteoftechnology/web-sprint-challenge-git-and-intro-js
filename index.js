...
who were born in and died in 20th century (1900-2000) example born in 1901 and died in 1959 - included / born 
in 1889 and died in 1925 not included - 
...
function get20s(data){
  ...
  for (i in data) {
    ...
    birth = parseInt(years[0])
  
    death = parseInt(years[1])
  
    if (birth >= 1900 && death <= 1999) {
...
/* Task 6: Create a function called `addArtist` that can accept an object of information and add it to
 the artists array. Then, add a 21st artist to the array (you) with custom information!👩‍🎨👨‍🎨
...
function addArtist(array, id, name, years, genre, nationality, bio){
  ...
  addArtist(artists,artists.length+1, `Samantha`, `1994 - ??`, `Abstract`, 'American', 'Consectetur adipiscing elit. Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem.')
