...
function get20s(array) {
  ...
  for (let i=0; i < array.length; i++) {
     const arrayYears = array[i].years.split(' - ');
     if (arrayYears > '1900' && arrayYears < '2000' ) {
...
function addArtist(array) {
  const newArtist = {
    ...
    genre: 'Web Design', 
    nationality: 'Somali',
    bio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla venenatis tempor vestibulum. Proin metus nisi, sagittis non nisl commodo, euismod finibus metus.' 
  }
  array.push(newArtist);
  return array
}
addArtist(artists);
console.log('task 6', artists[19]);
