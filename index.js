...
function addArtist(artists, name, years, genre, nationality, bio) {
  artists.push({name:name, years: years, genre: genre, nationality: nationality, bio: bio});
  return artists;
}

console.log('task 6', addArtist(artists, 'Avery Lambert', '1991-2022','full stack web developer','African American', 'I love to cook!'));
