...
function getArtistByIndex(entry, position) {
  /*Your Code Here*/
  return `the artist at index ${entry[position]['id']} is ${entry[position]['name']}`;
}  
...
function removeArtist(art, location){
   /*Your Code Here*/
   art.splice(location, 1);
   return art.length;
}
