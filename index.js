...
addArtist({
  ...
  bio:
    "Born in Brooklyn NYC, Jonathan is determined to make a life for himself as a software engineer and hopes to build a steady financial foundation for himself",
});
