...
console.log('the artist at index ' + this[0].id + ', is ' +
  this[0].name) 
...
const removeArtist = artists.splice(1.2)
...
const addArtist = artists.push( 'id: 20',
    'name: Vida Causey', 
    'years: 1970 - 2020',
    'genre: Web Design', 
