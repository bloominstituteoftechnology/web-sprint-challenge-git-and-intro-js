...
function getArtistByIndex(artistNamed, num) {
  return artistNamed[num];
}  
...
function get20s(twentieth){
  var twentieth = get20s.slice(1900, 2000);
}
...
function removeArtist(infamous){
   infamous.splice(0);
}
...
function addArtist(Chris A.){
    newBio.push({id: 20, name: "Chris A.", years: "1992 to current", genre: "Web Design", nationality: "Korean-American", bio: "lorem ipsum"});
  }
  console.log(newBio);
...
function lotsOfArt(artists){
  var artists = masters[100]
}

console.log(artists, 100);
