...
function get20s(data){
  data= [ artists.name, artists.years]
  for (let i = 0; i == 1800-1900; i++)
  return(get20s(artists.name))
...
"genre": "Web Design", 
"nationality": "IDK"
"bio": "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ante metus dictum at tempor commodo ullamcorper a lacus"
...
function lotsOfArt(array){
  for (i = 99; i< artists.paintings; i++){
