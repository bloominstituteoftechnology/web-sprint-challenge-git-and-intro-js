...
function get20s(array){
  return array.filter(array => array.years > "1900" && array.years < "2000");
}
...
const newToTheListArtist = {
  id: 20,
      name: "Yonathan Admasu", 
      years: "1988 - current day",
      genre: "Web Design", 
      nationality: "Ethiopian-American",
      bio: "Born and raised in Ethiopia, have been living in the states for the last decade or so, recently discovered his passion for codding and meditation."
}
function addArtist(array){
    return array.push(newToTheListArtist);
  }
