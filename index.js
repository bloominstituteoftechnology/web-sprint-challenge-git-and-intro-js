...
function get20s(array) {
  /*Your Code Here*/
  /* declare new array for names */
  let names = [];
  for (let i = 0; i < array.length; i++){
    /* grab years active and split into array */
    let years = array[i].years;
    let yearsActive = years.split(' - ');

    /* convert years active into int to compare */
    yearsActive[0] = parseInt(yearsActive[0]);
    yearsActive[1] = parseInt(yearsActive[1]);

    /* Make sure the years are between 1900-2000 */
...
function addArtist(array) {
  /*Your Code Here*/
  /*grab my info into object*/
  let me = { 
    id: 20,
    name: 'Jacob Haflett',
    years: '199? - current day',
    genre: 'Web Design, Heavy Bass ',
    nationality: 'Murican',
    bio: 'Jacob is cool and is the bestest. Bla bla bla Dale gribble.'
  }  
  /* add to array */
  array.push(me)
  return array
...
function lotsOfArt(array) {
  ...
  /* New Array */
  let names = []
  /*For Each item in array under length check to see if artist painted  more then 100 paintings*/
  for (let i = 0; i < array.length; i++){
    let paintings = array[i].paintings;
    if (paintings > 100){
    /*add the name of artist to the new array*/
