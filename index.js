...
function getArtistByIndex(name, id) {
 return console.log ("The artist at index " + artists.id + "is "+ $artists.name);
}/*
/* * For example, if getArtistByIndex is invoked with the artists dataset and the number 0,
* it will return `The artist at index 0 is Amedeo Modigliani`.
*/
function getArtistByIndex(/*Your Code Here*/ name, id) {
/*Your Code Here*/
return console.log ("The artist at index " + artists.id + "is " + $artists.name)
}
...
function get20s(/*Your Code Here*/artists){
  /*Your Code Here*/
  names(artists.filter(artists=>{(artists.years >= "1900") && (artists.years < "2000")}))
 console.log(result)
}
...
*/
function removeArtist(/*Your Code Here*/ artists, num) {
/*Your Code Here*/
function removeArtist(artists,num){
artists.slice(num);
console.log(artists[num], num);
};
...
function addArtist(/*Your Code Here*/ {id: num}, {name: string}, {years: string}, {genre: string}, {nationality: string}, {bio: string}){
/*Your Code Here*/
artists.push(   {id: "20",
                name: "Rodney Batts",
                 years: "1942 2020",
...
let prolificArtists = artists.filter(paintings);
function lotsOfArt(/*Your Code Here*/artists, prolificArtists){
/*Your Code Here*/
prolificArtists = filter(artists=>artists.paintings>number(100));
