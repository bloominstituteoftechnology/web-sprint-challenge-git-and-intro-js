...
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
(no function needed) 
There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method
 to fix this issue and console.log() to check your work. */
...
function get20s(array) {
  var searchParam = '1900-2000'.split('-');
  const results = [];
  for (let i = 0; i < array.length; i++) {
    
     //console.log(searchSubject[i]);
    if (array[i].years.split(' - ').slice(0,1) >= searchParam[0] ){   
        
     if(array[i].years.split(' - ').slice(1) <= searchParam[1] ) {
