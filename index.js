...
/*
function get20s(key, object, key2){
...
console.log(lotsOfArt("years",artists,"name"))
...
function lotsOfArt(key, object, key2, index){
  arr = []
for(
}
console.log(lotsOfArt("paintings",artists,"name", "id"))
