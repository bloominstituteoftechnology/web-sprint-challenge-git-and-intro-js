...
console.log(artists[0].name, artists[0].bio)
...
function get20s(array){
  ...
  array.forEach(artist => {
    let birthYears = artist.years.split(" - ")
    let birthYear = Number(birthYears[0])
    let deathYear = Number(birthYears[1])
...
const newArtist = {
  ...
  bio: "I'm a gamer and Twitch streamer. Learning how to code at Lambda School."
}
