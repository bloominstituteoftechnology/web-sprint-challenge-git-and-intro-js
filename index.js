...
function get20s(array){
  /*Your Code Here*/
  let newArray = [];
  const born = array[ ].years.slice(0,4);
  const died = array[ ].years.slice(7,11);
...
function addArtist(array){
    ...
    let add = array.push( 
      {
      id: 20,
      name: 'Alphonso Cornelius',
      years: '1992-2021',
      genre: 'Web Desing',
      nationaltity: 'American',
      bio: 'Looking forward to graduating from lambda and beginning my journey with building and desiging website'
    }
    )
    return array;
  }
